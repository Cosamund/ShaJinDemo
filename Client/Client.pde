...
int Weight;      // HOLDS WEIGHT VALUE FROM ARDUINO
int Counter;     // HOLDS COUNTER VALUE FROM ARDUINO
int Ans;         //  ANSWER RESULT
int CMin;      //  CMin RESULT
...
// PRINT THE DATA AND VARIABLE VALUES
  ...
  text(Weight + " Weight",600,150);                     // print the Beats Per Minute
  text(Counter + " Counter",600,170);                   // print the Beats Per Minute
  text(Ans + " Ans",600,120);                           // print the answer
  text(CMin + " CMin",600,100);                           // print the answer
